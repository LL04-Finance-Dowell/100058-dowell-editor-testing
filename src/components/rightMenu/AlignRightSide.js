      ...
      <Container fluid className="px-2 p-0">
        <Row className="pt-0">
          <Col>
            ...
            <select
              id="select_font"
              className="bg-color text-secondary border-0 rounded w-100 h-75 select"
              onChange={changeFont}
            >
        ...
        <Row className="pt-4">
          ...
          <Col>
            <select
              ...
              className="select border-0 bg-color rounded w-100 h-100"
              id="font-sizing"
            >
          ...
          <Col>
            <Button
              ...
              className="d-flex select bg-color rounded"
            >
        ...
        <Row className="pt-0">
          <div className='dropdown'>
            <h6>Group Elements</h6>
            <select className='shadow bg-white text-secondary rounded w-100 h-50 border-0 rounded  select'>
